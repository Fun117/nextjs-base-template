...
export default function PageClientLayout({ title, description }: { title: string, description?: string}) {
...
function ClientComponent({ title, description }: { title: string, description?: string}) {
